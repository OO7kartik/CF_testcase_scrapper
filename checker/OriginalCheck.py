#this does not work, when we reach the solution page, we have to make a click to be able to scrape....
#to update to add a clicker to make it scrape.
...
for mydivs in soup.find_all("div", class_ = "file input-view"):
    ...
    if(len(divs) > 3 and divs[len(divs)-3] == '.'):
